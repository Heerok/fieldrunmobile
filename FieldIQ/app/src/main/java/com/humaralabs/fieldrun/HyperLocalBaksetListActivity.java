...
import com.humaralabs.fieldrun.adapter.HyperBasketListAdapter;
...
public class HyperLocalBaksetListActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db=new DbAdapter(HyperLocalBaksetListActivity.this);
        tiny=new TinyDB(HyperLocalBaksetListActivity.this);
        hyperbasketList=new ArrayList<HyperBasket>();


        setTripActionButton();
        GPSChecker.GPSCheck(HyperLocalBaksetListActivity.this, false);
    ...
    protected void onResume() {
        ...
        GPSChecker.GPSCheck(HyperLocalBaksetListActivity.this, false);
        //start service
        CommonFunctions.StartSevice(HyperLocalBaksetListActivity.this);
    ...
    public void refreshView() {
        ...
        CommonFunctions.showActiveNotification(HyperLocalBaksetListActivity.this, TextToDisplay);
    }
    ...
    public void refreshList(int taskstatus, final Long tripId) {
        ...
        ExpandList = (ExpandableListView) findViewById(R.id.basketlist);
        HyperBasketListAdapter basketListAdapter = new HyperBasketListAdapter(HyperLocalBaksetListActivity.this, hyperbasketList,tripOrigin,tripFacility,tripExpiryDateTime);
        if(android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.JELLY_BEAN_MR2) {
            ExpandList.setIndicatorBounds(width - GetPixelFromDips(150), width - GetPixelFromDips(100));
        } else {
            ExpandList.setIndicatorBoundsRelative(width - GetPixelFromDips(50), width - GetPixelFromDips(10));
        }
        ExpandList.setAdapter(basketListAdapter);
    ...
    public void AutomaticLogout(){
        ...
        Toast.makeText(HyperLocalBaksetListActivity.this, "Authentication error! Please Login Again.", Toast.LENGTH_LONG).show();
